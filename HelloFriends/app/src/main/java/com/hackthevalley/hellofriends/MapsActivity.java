...
//        }
    ...
    public void AddData(int i, double lat, double lon, double time) {
        db.insertData(i, lat, lon, time);
    }
    public void AddData() {
        db.insertData(1, 1.01111, 1.0222, 1.0333);
        db.insertData(2, 4.01111, 2.0222, 2.0333);
        db.insertData(3, 3.01111, 3.0222, 3.0333);
    }
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    public void onLocationChanged(Location location) {
        ...
        db.insertData(123, location.getLatitude(),location.getLongitude(),System.currentTimeMillis() / 1000.0 / 60 / 60-439407.288853056);
//        try {
...
//                    AddData(1234, temp[0], temp[1], temp[2]);
...
//            if (makeNew) {
//                history.add(temp);
//                AddData(123, temp[0], temp[1], temp[2]);
//                Log.d("sql data", getData());
//            }
//
//        }
